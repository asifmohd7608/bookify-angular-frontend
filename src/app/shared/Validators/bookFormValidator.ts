import { AbstractControl } from "@angular/forms";
 ...
 export function stockValidator(control: AbstractControl):{ [key: string]: any } | null {
 ...
 export function availableValidator(control: AbstractControl):{ [key: string]: any } | null {
 ...
 export function isbnValidator(control: AbstractControl):{ [key: string]: any } | null {
    let pattern=/^\d+$/
